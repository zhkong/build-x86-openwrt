...
tar zxvf clash-linux-amd64.tar.gz && rm -f clash-linux-amd64.tar.gz
mv ./clash ./files/etc/openclash/core/clash

wget https://raw.githubusercontent.com/vernesong/OpenClash/core/master/premium/clash-linux-amd64-2023.08.17-13-gdcc8d87.gz -O clash_tun.gz
gzip -d clash_tun.gz
chmod +x clash_tun
